...
use crate::db;
use crate::models::{Status, CreatTodoList, ResultResponse};
...
pub async fn create_todo(db_pool: web::Data<Pool>, json: web::Json<CreatTodoList>) ->impl Responder{
    let client: Client = db_pool.get().await.expect("Error connecting to the database");
...
pub async fn check_items(db_pool: web::Data<Pool>, path: web::Path<(i32,i32)>) ->impl Responder{
